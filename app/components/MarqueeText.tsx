...
const MarqueeText = ({ text }: { text: string }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="font-grotesk mb-20 mt-32 inline-block text-4xl font-normal uppercase tracking-wide xs:text-5xl sm:text-7xl md:text-[8rem] lg:text-[9rem] xl:text-[10rem] 2xl:text-[11rem]">
